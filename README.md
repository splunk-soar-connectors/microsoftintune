...
This table lists the configuration variables required to operate Microsoft Intune. These variables are specified when configuring a Intune asset in Splunk SOAR.
